        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Culinary City, FC 12345</p>
                </div>
              </div>
            ...
            <div className="mt-8 p-6 bg-orange-50 rounded-lg">
              <h3 className="font-semibold text-gray-900 mb-2">Quick Support</h3>
              <p className="text-gray-600 text-sm mb-4">
                For immediate assistance with your order, please call our hotline or use the contact form.
              </p>
              <p className="text-orange-500 font-semibold">Hotline: +1 (555) 999-0000</p>
            </div>
          </div>
